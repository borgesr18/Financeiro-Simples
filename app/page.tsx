...
// Supabase pode retornar objeto OU array dependendo do relacionamento.
// Tipamos de forma ampla e normalizamos ao renderizar.
type RowRaw = {
  id: string
  date: string
  description: string
...
export default async function HomeTransactionsPage() {
