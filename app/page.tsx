    ...
    <main className="flex-1 overflow-y-auto p-4 md:p-6 bg-neutral-50">
      ...
      <section className="mb-6">
        <div className="flex flex-col md:flex-row md:items-center justify-between">
          <div>
            <h2 className="text-2xl font-bold text-neutral-800">Bom dia!</h2>
            <p className="text-neutral-500">Seu panorama financeiro deste mês</p>
          </div>
          <div className="mt-4 md:mt-0 flex space-x-3">
            <a href="/transactions" className="px-4 py-2 bg-white border border-neutral-200 rounded-lg text-neutral-600 hover:bg-neutral-50 flex items-center">
              Ver tudo
            </a>
            <a href="/add" className="px-4 py-2 bg-primary-500 text-white rounded-lg hover:bg-primary-600 transition-colors flex items-center">
              Novo lancamento
            </a>
          </div>
        </div>
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        <div className="bg-white rounded-xl shadow-card p-5 hover:shadow-card-hover transition-shadow">
          ...
          <div className="flex items-center text-success text-sm"><span>mes atual</span></div>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-card p-5 hover:shadow-card-hover transition-shadow">
          <div className="flex items-center justify-between mb-4">
            <div className="text-neutral-500 text-sm font-medium">Saidas</div>
          ...
          <div className="flex items-center text-danger text-sm"><span>mes atual</span></div>
        </div>

        <div className="bg-white rounded-xl shadow-card p-5 hover:shadow-card-hover transition-shadow">
          <div className="flex items-center justify-between mb-4">
            <div className="text-neutral-500 text-sm font-medium">Poupanca</div>
        ...
        <section className="lg:col-span-2 bg-white rounded-xl shadow-card p-5 hover:shadow-card-hover transition-shadow">
          <div className="flex items-center justify-between mb-5">
            <div>
              ...
              <p className="text-sm text-neutral-500">Padroes de gastos ao longo do tempo</p>
            </div>
        ...
        <section className="bg-white rounded-xl shadow-card p-5 hover:shadow-card-hover transition-shadow">
          <div className="flex items-center justify-between mb-5">
            <div>
              ...
              <p className="text-sm text-neutral-500">Mes atual</p>
            </div>
          ...
          <div className="grid grid-cols-2 gap-3 text-sm text-neutral-600">
            <div className="flex items-center"><span className="w-3 h-3 rounded-full bg-primary-400 mr-2" />Moradia (40%)</div>
            <div className="flex items-center"><span className="w-3 h-3 rounded-full bg-secondary-400 mr-2" />Alimentacao (20%)</div>
            <div className="flex items-center"><span className="w-3 h-3 rounded-full bg-green-400 mr-2" />Transporte (15%)</div>
            <div className="flex items-center"><span className="w-3 h-3 rounded-full bg-yellow-400 mr-2" />Compras (15%)</div>
            <div className="flex items-center"><span className="w-3 h-3 rounded-full bg-red-400 mr-2" />Lazer (10%)</div>
          </div>
        </section>
      </div>
    </main>
