        ...
        <div className="flex h-screen overflow-hidden">
          ...
          <aside className="hidden md:flex md:flex-col w-64 bg-white border-r border-neutral-200">
            ...
            <div className="p-4 border-t border-neutral-100">
              <div className="flex items-center">
                ...
                />
                <div>
                  <p className="text-sm font-medium text-neutral-800">Você</p>
                  <p className="text-xs text-neutral-500">logado</p>
                </div>
                <button className="ml-auto text-neutral-400 hover:text-neutral-600" aria-label="Configurações">
                  <FaCog />
                </button>
              </div>
            </div>
          ...
          <div className="flex-1 flex flex-col overflow-hidden">
            ...
            <header className="bg-white border-b border-neutral-200 p-4 flex items-center justify-between">
              <button className="md:hidden text-neutral-500 hover:text-neutral-700" aria-label="Abrir menu">
                <FaBars className="text-xl" />
              </button>

              <div className="hidden md:block">
                <h1 className="text-xl font-semibold text-neutral-800">Financeiro Simples</h1>
              </div>
              ...
              <div className="flex items-center space-x-3">
                <button className="p-2 text-neutral-500 hover:text-neutral-700 hover:bg-neutral-50 rounded-full" aria-label="Notificações">
                  <FaBell />
                </button>
                <Link
                  href="/add"
